...
const services = [
  ...
  {
    title: "Saree Rolling",
    description: "Introducing a first-of-its-kind saree care experience by TheLaundryGuyz — the first laundry chain offering dedicated Saree Rolling services. Every saree entrusted to us is treated with precision, care, and respect for its artistry. Using professional-grade rolling technology and premium finishing options, we help maintain the saree’s original beauty, graceful drape, and lasting elegance wash after wash.", image: sareeRollingImg,
    features: [
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? "lg:order-1" : ""}>
                  ...
                  <Button variant="hero" size="lg" onClick={() => openModal('book')}>
                    Book This Service
