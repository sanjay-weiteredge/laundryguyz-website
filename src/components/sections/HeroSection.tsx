...
const HeroSection = () => {
  ...
  const features = [
    ...
    { icon: MapPinned, text: "15+ Service Range " },
  ];
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[85vh] py-16">
          ...
          <div className="order-2 lg:order-1">
            ...
            <h1 className="font-serif text-3xl md:text-4xl lg:text-4xl font-bold text-foreground leading-tight mb-6 animate-fade-up delay-100">
              We Are The First & Only <span className="text-gradient">Laundry Chain</span> with Exclusive Saree Rolling!
            </h1>

            <p className="text-base text-muted-foreground max-w-xl leading-relaxed mb-4 animate-fade-up delay-200">
              From expert laundry & dry-cleaning to being the first exclusive Saree Rolling service, TheLaundryGuyz redefines premium fabric care with meticulous attention, professional finishing, and free doorstep pickup & delivery*
            </p>
            <p className="text-base text-muted-foreground mb-4 max-w-xl leading-relaxed animate-fade-up delay-200">
              Schedule your order through our website, give us a call, use our app or walk-in to our stores!
            </p>
            <p className="text-lg font-semibold text-primary italic mb-8 max-w-xl leading-relaxed animate-fade-up delay-200">
              Laundry, done better!
            </p>
